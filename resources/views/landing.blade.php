    ...
    <div class="container margin_60_40">
        <div class="flex-container what-box">
            ...
            <div class="what-image">
                <img class="img-responsive lazy" data-src="{{ mix('img/whatis.png') }}" alt="whatistlg">
            </div>
        </div>
    </div>
    <!-- /container -->
    ...
    <div class="bg_gray">
        <div class="container margin_60_40">
            ...
            <div class="owl-carousel owl-theme categories_carousel">
                <div class="item">
                    <a>
                        <img class="lazy" data-src="{{ mix('img/step1.png') }}">
                ...
                <div class="item">
                    <a>
                        <img class="lazy" data-src="{{ mix('img/step2.png') }}">
                ...
                <div class="item">
                    <a>
                        <img class="lazy" data-src="{{ mix('img/step3.png') }}">
                ...
                <div class="item">
                    <a>
                        <img class="lazy" data-src="{{ mix('img/step4.png') }}">
                ...
                <div class="item">
                    <a href="{{ route('orders.create') }}">
                        <img class="lazy" data-src="{{ mix('img/whatis.png') }}">
